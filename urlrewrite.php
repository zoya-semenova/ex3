...
$arUrlRewrite = array(
    ...
    949 => array(
        'CONDITION' => '#^/extranet/crm/type/(.+)/(.+)/category/(.+)/.*#',
        'RULE' => 'type=$1&component=$2&category=$3',
        'ID' => 'bitrix:crm.router1',
        'PATH' => '/extranet/smart-process/index.php',
        'SORT' => 100,
    ),
    951 =>
        array(
            'CONDITION' => '#^/extranet/crm/type/(.+)/details/([0-9]+)/.*#',
            'RULE' => 'type=$1&id=$2',
            'ID' => 'bitrix:crm.router2',
            'PATH' => '/extranet/smart-process/detail.php',
            'SORT' => 100,
        ),
    952 =>
        array(
            'CONDITION' => '#^/extranet/crm/company/details/([0-9]+)/.*#',
            'RULE' => 'id=$1',
            'ID' => 'bitrix:crm.company',
            'PATH' => '/extranet/company/index.php',
            'SORT' => 100,
        ),
